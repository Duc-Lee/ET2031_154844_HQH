...
for i in range(numberOfInsects):
    ...
    insectMoveX.append(6)  # Tốc độ di chuyển bóng theo chiều X
    insectMoveY.append(4)  # Tốc độ di chuyển bóng theo chiều Y
...
while True:
    ...
    for i in range(numberOfBombs):
        ...
        if bombMoveY[i].top <= 0:
            bombMoveY[i] += 5
        elif bombMoveY[i].top >= height - 32:
            bombMoveY[i] -= 5
